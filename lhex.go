/*
Package lhex allows reading and writing hexdump-style data.

It is meant to be familiar to users of the hex package, but provides additional
features, including an ability to both read *and* write using this as a data
format, and labels attached to offsets which can be accessed later.

File Format

The basic file format looks like this:
